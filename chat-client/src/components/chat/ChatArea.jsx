...
const ChatArea = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative">
      <ChatHeader />
      <MessageList />
      {typingUsers.length > 0 && (
        <div className="px-6 py-2 text-sm text-purple-300 flex items-center gap-2">
